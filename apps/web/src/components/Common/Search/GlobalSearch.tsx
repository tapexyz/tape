...
const GlobalSearch = () => {
  ...
  const Content = () => (
    <>
      ...
      <div
        className={clsx(
          'rounded-medium tape-border dark:bg-brand-850 z-10 mt-1 w-[300px] md:w-[500px] bg-white text-base shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none md:absolute',
