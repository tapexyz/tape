...
const MobileBottomNav = () => {
  ...
  return (
    <div className="pb-safe fixed inset-x-0 bottom-0 z-10 border-t-[0.5px] border-gray-300 bg-white/90 backdrop-blur-xl dark:border-gray-700 dark:bg-brand-850/90 md:hidden">
