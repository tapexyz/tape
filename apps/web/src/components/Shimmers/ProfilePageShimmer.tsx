  ...
  return (
    <>
      <div className="flex animate-shimmer flex-col">
        <div className="h-44 ultrawide:h-[25vh] bg-gray-100 md:h-[20vw] dark:bg-gray-800" />
      ...
      <div className="mx-auto max-w-screen-xl px-2 xl:px-0">
        <div className="no-scrollbar flex items-center space-x-4 overflow-x-auto border-gray-200 border-b pt-2 pb-3 dark:border-gray-700">
