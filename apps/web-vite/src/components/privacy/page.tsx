    ...
    <div className="flex min-h-screen flex-col rounded-card bg-theme px-2 pb-20">
      ...
      <div className="prose-sm md:prose dark:prose-invert mx-auto prose-a:font-semibold prose-a:text-primary hover:prose-a:underline">
        ...
        <p>
          ...
          to our <Link to="/terms">terms of use</Link> and any other written
          agreements for using the Site. And you agree to our collection and use
          of any personal data (as described here) as well as the features of
        ...
        <p>
          ...
          uses, and shares information about you in connection with the website
          at tape.xyz, as well as your rights and choices regarding such
          information.
        </p>
        <p>
          By accessing or using the Site, you accept and assume certain inherent
          features related to engaging in recording the data on the blockchain.
          Interactions with the Lens Protocol rely on smart contracts stored on
          a publicly available blockchain, cryptographic tokens generated by the
          smart contracts, and other nascent software, applications and systems
          that interact with blockchain-based networks. One of the defining
          features of blockchain technology is that its entries are immutable,
          which means, as a technical matter, they generally cannot be deleted
          or modified by anyone. If you are not comfortable assuming the
          inherently immutable and public nature of all entries on the
          blockchain, you should not engage with our Site.
        </p>
        ...
        <div>
          ...
          <li>
            <b>Cookies</b>, small data stored on your device that are necessary
            for you to browse the Site. These are same-site (first-party)
            cookies and are not shared with third parties.
          </li>
          <li>
            <b>Public Information</b>, data from activity that is publicly
            visible and/or accessible on blockchains. This may include
            blockchain addresses and information regarding the NFTs in wallets.
          </li>
        </div>
        <h2>3. Use of Information</h2>
        <p>
          We use your information solely as necessary to operate and manage the
          Services on this Site (or other places), provide you support, ensure
          we comply with laws and regulation, and enforce the security of the
          Site or make other improvements.
        </p>
        <h2>4. Third-Parties</h2>
        <p>
          This Privacy Policy does not apply to websites, apps, products, or
          services that we do not own or control. For example, your interactions
          with Ethereum wallet are governed by the applicable privacy policies
          of that particular wallet.
        </p>
        <h2>5. Analytics</h2>
        <p>
        ...
        <p>
          The main goal of collecting this data is to enhance the functionality
          and user experience. By understanding how users engage with site, we
          can make more tailored decisions about where to focus our improvement
          efforts.
        </p>
        <li>Your data never leaves our controlled environment.</li>
        <li>We do not share this data with third-party analytics providers.</li>
        ...
        <div>
          ...
          <li>
            ...
            services you visit. Note, however, there is no industry consensus as
        ...
        <p>
          ...
          children. To use the Site, you must legally be able to enter into the
        ...
        <p>
          ...
          use of the Site indicates your consent to the revised Privacy Policy
          then posted.
        </p>
        <h2>10. Contact Us</h2>
        <p>
