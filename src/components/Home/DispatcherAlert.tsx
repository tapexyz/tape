    ...
    <div className="w-full mb-4">
      <div className="relative flex flex-col p-6 overflow-hidden lg:p-8 rounded-xl">
        ...
        <div className="absolute top-0 right-0 flex items-center justify-center translate-x-2 opacity-60 md:opacity-100">
          <div className="absolute border-2 border-black rounded-full dark:border-white w-96 h-96 opacity-10"></div>
          <div className="absolute border-2 border-black rounded-full dark:border-white w-80 h-80 opacity-10"></div>
          <div className="absolute w-64 h-64 border-2 border-black rounded-full dark:border-white opacity-20"></div>
          <div className="absolute w-48 h-48 border-2 border-black rounded-full dark:border-white opacity-20"></div>
          <div className="absolute w-32 h-32 border-2 border-black rounded-full dark:border-white opacity-30"></div>
          <div className="absolute w-20 h-20 border-2 border-black rounded-full dark:border-white opacity-30"></div>
          <div className="absolute w-10 h-10 border-2 border-black rounded-full dark:border-white opacity-40"></div>
        </div>
      </div>
    </div>
  )
