    ...
    <div className="flex items-center space-x-2.5">
      ...
      >
        <SwitchPrimitives.Thumb
          className={tw(
            "pointer-events-none block h-4 w-4 rounded-full bg-card ring-0 transition-transform data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0 dark:bg-black/60"
          )}
        />
      </SwitchPrimitives.Root>
