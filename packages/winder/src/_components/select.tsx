...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={tw(
      "flex h-10 w-full items-center justify-between rounded-custom border border-custom bg-theme px-3 py-2 text-sm placeholder:text-muted-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={tw(
        ...
        "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-custom border border-custom bg-theme",
        position === "popper" &&
