...
>(({ className, ...props }, ref) => {
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb className="block h-4 rounded-sm bg-brand-850 px-1 text-xs font-bold text-white focus:outline-none active:scale-110 dark:bg-white dark:text-black">
        {props.value}
