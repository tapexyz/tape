...
const documents: Documents = {
    ...
    "fragment PayToCollectConfigFields on PayToCollectConfig {\n  referralShare\n  recipients {\n    address\n    percent\n  }\n  amount {\n    ...Erc20AmountFields\n  }\n}": types.PayToCollectConfigFieldsFragmentDoc,
    "fragment SimpleCollectActionFields on SimpleCollectAction {\n  address\n  collectLimit\n  isImmutable\n  endsAt\n  payToCollect {\n    ...PayToCollectConfigFields\n  }\n}": types.SimpleCollectActionFieldsFragmentDoc,
    "fragment UnknownPostActionFields on UnknownPostAction {\n  __typename\n}": types.UnknownPostActionFieldsFragmentDoc,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment PayToCollectConfigFields on PayToCollectConfig {\n  referralShare\n  recipients {\n    address\n    percent\n  }\n  amount {\n    ...Erc20AmountFields\n  }\n}"): typeof import('./graphql').PayToCollectConfigFieldsFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment UnknownPostActionFields on UnknownPostAction {\n  __typename\n}"): typeof import('./graphql').UnknownPostActionFieldsFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query MLPostsExplore($request: PostsExploreRequest!) {\n  mlPostsExplore(request: $request) {\n    items {\n      ... on Post {\n        ...PostFields\n      }\n    }\n    pageInfo {\n      next\n    }\n  }\n}"): typeof import('./graphql').MlPostsExploreDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
